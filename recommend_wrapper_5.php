<div class="recommend_wrapper" id="recommend_wrapper_5">
    ...
    <div id="recommend_block_5" class="recommend_block">
        <div class="three_groups">
	        ...
	        <div class="group card middle_group">
	        	<a class="group-image-link" href="groupPage.php">
        ...
        <div class="three_groups last_in_recommend_block">
	    	<div class="group card">
	    		<a class="group-image-link" href="groupPage.php">
