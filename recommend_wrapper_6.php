<div class="recommend_wrapper" id="recommend_wrapper_6">
    ...
    <div id="recommend_block_3" class="recommend_block">
        <div class="recommend_event">
            <div class="event_block card">
                <a target="" href="hotUser.html">
                    <img class="event-pic" src="./Pics/superman.jpg">
                </a>
                <a target="" href="">
                ...
                <div class="event_info">
                    <p>
                    	...
                    	時間: 6月16日(日)<br/>
                    	地點: 台北<br/>
						已參加: <span class="red-text">3</span>人
					</p>
                </div>    
        ...
        <div class="recommend_event last_in_recommend_block">
            <div class="event_block card">
                <a target="" href="hotUser.html">
                    <img class="event-pic" src="./Pics/guitar.jpg">
                </a>
                <a target="" href="">
                    <div class="event_title">
                        <h1>
